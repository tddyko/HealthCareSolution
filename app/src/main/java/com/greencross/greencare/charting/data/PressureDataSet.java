 ...
 */
public class PressureDataSet extends LineScatterCandleRadarDataSet<PressureEntry> implements IPresureDataSet {
    ...
    public DataSet<PressureEntry> copy() {
        ...
        List<PressureEntry> yVals = new ArrayList<PressureEntry>();
        yVals.clear();
        ...
        PressureDataSet copied = new PressureDataSet(yVals, getLabel());
